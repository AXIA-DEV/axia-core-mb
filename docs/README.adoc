...
See also https://www.axiacoin.network/what-is-substrate/.
...
You can use https://github.com/axiatech/scripts/tree/master/dockerfiles/ci-linux[Parity CI docker image] with all necessary dependencies to build Substrate:
